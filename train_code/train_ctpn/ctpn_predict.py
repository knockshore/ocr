...
weights = os.path.join(config.checkpoints_dir, 'v3_ctpn_ep32_0.6722_0.1103_0.7825.pth')#'ctpn_ep17_0.0544_0.1125_0.1669.pth')
...
def get_det_boxes(image,display = True):
    image = resize(image, height=4096)
    image_c = image.copy()
    h, w = image.shape[:2]
